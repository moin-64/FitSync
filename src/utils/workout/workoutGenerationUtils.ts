  ...
  try {
    ...
    try {
      ...
      if (error) {
        ...
        console.log("Received AI workout suggestions:", aiSuggestions.substring(0, 100) + "...");
      }
    } catch (aiError) {
    ...
    console.log(`Successfully generated workout with ${exercisesWithRest.length} exercises`);
    
    return [warmup, ...exercisesWithRest];
  } catch (error) {
    console.error("Error generating AI workout:", error);
    
    // More robust fallback workout generation
